...
import com.example.aniket.openinfotech_weatherapp.AlarmReceiver;
import com.example.aniket.openinfotech_weatherapp.Constants;
import com.example.aniket.openinfotech_weatherapp.R;
import com.example.aniket.openinfotech_weatherapp.adapters.ViewPagerAdapter;
import com.example.aniket.openinfotech_weatherapp.adapters.WeatherRecyclerAdapter;
import com.example.aniket.openinfotech_weatherapp.fragments.RecyclerViewFragment;
import com.example.aniket.openinfotech_weatherapp.models.Weather;
import com.example.aniket.openinfotech_weatherapp.tasks.GenericRequestTask;
import com.example.aniket.openinfotech_weatherapp.tasks.ParseResult;
import com.example.aniket.openinfotech_weatherapp.tasks.TaskOutput;
import com.example.aniket.openinfotech_weatherapp.utils.UnitConvertor;
import com.example.aniket.openinfotech_weatherapp.widgets.AbstractWidgetProvider;
import com.example.aniket.openinfotech_weatherapp.widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        android.support.v7.app.AlertDialog.Builder alert = new android.support.v7.app.AlertDialog.Builder(this);
        alert.setTitle("Open_Infotech Weather App");
    ...
    private ParseResult parseTodayJson(String result) {
        try {
            ...
            if (windObj.has("deg")) {
                ...
                Log.e("parseTodayJson", "Nooo direction available");
...
//    }
    ...
    public void onLocationChanged(Location location) {
        ...
        try {
            ...
            Log.e("LocationManager", "Error while trying to stop listening for location updates. This is  a permissions issue", e);
        }
