package com.example.aniket.openinfotech_weatherapp;
...
import com.example.aniket.openinfotech_weatherapp.activities.MainActivity;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public class GetLocationAndWeatherTask extends AsyncTask <String, String, Void> {
        ...
        @Override
        protected void onPreExecute() {
            Log.d(TAG, "Trying to find location...");
            ...
            try {
                ...
                Log.e(TAG, "can't request location updates. Probably this is an Android (>M) runtime permissions issue ", e);
            }
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (location != null) {
                ...
                Log.e(TAG, "can't determine location. Using last known location.");
                new GetWeatherTask().execute();
                new GetLongTermWeatherTask().execute();
            }
            try {
                ...
                Log.e(TAG, "can't remove location updates. Probably this is an Android (>M) runtime permissions", e);
            }
        }
